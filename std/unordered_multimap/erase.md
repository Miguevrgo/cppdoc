---
symbol: std::unordered_multimap::erase
header: <unordered_map>
since: C++11
---

Removes specified elements from the unordered_multimap.
...
- 1, 2. Removes the element at `pos`, which must be a valid, dereferenceable iterator into the unordered_multimap. Returns an iterator to the element following the erased one.
...
O(1) on average per erased element. Linear in the size of the unordered_multimap in the worst case.
